require(["modules/jquery-mozu",
    ...
    function($, _, Hypr, Backbone, messageViewFactory, CartMonitor, HyprLiveContext, EditableView, preserveElements,
        CheckoutModels, CheckoutStepView, ShippingDestinationsView, ShippingMethodsView, PaymentView, ContactDialogView, onImageLoadError, blockUiLoader) {
        ...
        var OrderSummaryView = Backbone.MozuView.extend({
            ...
            render: function() {
                ...
                $(".mz-order-summary-image img, img[data-mz-check-image]").on("error", function() {
                    onImageLoadError.checkImage(this);
                });
            },
            editCart: function() {
        ...
        $(document).ready(function() {
            ...
            checkoutModel.on('complete', function() {
                ...
                window.location = "/checkoutv2/" + checkoutModel.get('id') + "/confirmation";
            });
